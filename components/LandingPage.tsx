...
export const LandingPage: React.FC<LandingPageProps> = ({ onLogin, darkMode, toggleTheme }) => {
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-white font-sans overflow-x-hidden selection:bg-teal-500 selection:text-white">
            {/* Navbar */}
            <nav className="fixed w-full z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-200 dark:border-slate-800 transition-all duration-300">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-20">
                        <div className="flex items-center gap-2.5">
                            <div className="w-9 h-9 bg-gradient-to-br from-teal-500 to-teal-700 rounded-lg flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-teal-500/20">
                                AE
                            </div>
                            <span className="font-bold text-xl tracking-tight text-gray-900 dark:text-white">AuditEra</span>
                        </div>
                        <div className="hidden md:flex space-x-8 text-sm font-medium text-gray-600 dark:text-slate-300">
                            ...
                            <a href="#security" className="hover:text-teal-600 dark:hover:text-teal-400 transition-colors">Security</a>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button onClick={onLogin} className="bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-5 py-2.5 rounded-full text-sm font-bold transition-all shadow-lg hover:shadow-xl hover:scale-105 active:scale-95">
                                Launch App
                            </button>
                        </div>
                    </div>
            ...
            <section className="relative min-h-[90vh] flex items-center justify-center pt-20 overflow-hidden bg-slate-900">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-slate-900/0 via-slate-900/50 to-slate-900 pointer-events-none z-0"></div>

                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-500/10 border border-teal-500/20 text-teal-300 text-xs font-bold uppercase tracking-wider mb-8 animate-fade-in backdrop-blur-sm">
                        <span className="w-2 h-2 rounded-full bg-teal-400 animate-pulse"></span>
                        Client Data Never Leaves Your Device
                    </div>
                    
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-8 text-white animate-fade-up leading-tight">
                        The AI OS for <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-200 via-teal-400 to-blue-500">Modern CA Firms</span>
                    </h1>
                    
                    <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-300 mb-12 animate-fade-up delay-100 font-light leading-relaxed">
                        Automate tax computations, compliance monitoring, and billing with a 
                        <span className="font-semibold text-white"> local-first AI </span> 
                        that guarantees 100% data privacy.
                    </p>
                    
                    <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-up delay-200">
                        <button onClick={onLogin} className="px-8 py-4 bg-teal-500 hover:bg-teal-400 text-gray-900 rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(20,184,166,0.5)] transition-all transform hover:-translate-y-1 hover:scale-105">
                    ...
                    {/* Stats */}
                    <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-white/10 pt-8 animate-fade-up delay-300">
                         <div>
                         ...
                         <div>
                             ...
                             <p className="text-xs text-slate-400 uppercase tracking-wide mt-1">Cloud Latency</p>
                         </div>
                         <div>
                             <p className="text-3xl font-bold text-white">AES-256</p>
                             <p className="text-xs text-slate-400 uppercase tracking-wide mt-1">Encryption</p>
                         </div>
                         <div>
                             <p className="text-3xl font-bold text-white">50+</p>
                             <p className="text-xs text-slate-400 uppercase tracking-wide mt-1">Automation Tools</p>
                         </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <p className="text-xs font-bold text-gray-400 dark:text-slate-500 uppercase tracking-widest mb-8">Trusted by 500+ Forward-Thinking Firms</p>
                    <div className="flex flex-wrap justify-center gap-10 md:gap-20 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
                        {['Apex Partners', 'Mehta & Co', 'Global Tax', 'FinTech Solutions', 'LegalEase'].map(logo => (
                            <span key={logo} className="text-2xl font-black text-gray-800 dark:text-white tracking-tighter">{logo}</span>
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section id="features" className="py-32 bg-gray-50 dark:bg-slate-900 relative">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-5xl font-extrabold mb-6 text-gray-900 dark:text-white">Command Center for CAs</h2>
                        <p className="text-xl text-gray-600 dark:text-slate-400 max-w-3xl mx-auto">Replace fragmented tools with one integrated, secure operating system designed for high-performance firms.</p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="p-8 bg-white dark:bg-slate-800 rounded-3xl border border-gray-100 dark:border-slate-700 shadow-xl hover:shadow-2xl transition-all duration-300 group hover:-translate-y-2">
            ...
            {/* Security Section */}
            <section id="security" className="py-32 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-16 relative z-10">
                    <div className="flex-1 space-y-8">
                        ...
                        <p className="text-xl text-slate-400 leading-relaxed">
                            ...
                            Your sensitive financial data is stored encrypted on your browser/device.
                        </p>
                            ...
                            <div className="relative bg-slate-800 p-8 rounded-2xl border border-slate-700 shadow-2xl">
                                ...
                                <div className="space-y-6 font-mono text-sm">
                                    <div className="flex justify-between items-center text-slate-400">
                                        ...
                                        <span className="text-white bg-slate-700 px-2 py-1 rounded">AES-256-GCM</span>
                                    </div>
                                    <div className="flex justify-between items-center text-slate-400">
                                        <span>Database Location</span>
                                        <span className="text-white bg-slate-700 px-2 py-1 rounded">IndexedDB (Local)</span>
                                    </div>
                                    <div className="flex justify-between items-center text-slate-400">
                                        <span>Cloud Sync</span>
                                        <span className="text-red-400 bg-red-900/20 px-2 py-1 rounded border border-red-900/30">Disabled (Privacy Mode)</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="pricing" className="py-32 bg-white dark:bg-slate-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        ...
                        {/* Growth (Highlighted) */}
                        <div className="bg-slate-900 dark:bg-slate-800 p-10 rounded-3xl border-2 border-teal-500 shadow-2xl flex flex-col relative transform md:-translate-y-6 z-10">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-4 gap-12">
                    <div className="col-span-2">
                        <div className="flex items-center gap-2.5 mb-6">
                             <div className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center text-white font-bold text-sm">AE</div>
                             <span className="font-bold text-gray-900 dark:text-white text-xl">AuditEra</span>
                        </div>
                        ...
                        <p className="text-xs font-medium">Made with ❤️ in India</p>
                    </div>
                    <div>
